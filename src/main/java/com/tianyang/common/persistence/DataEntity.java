 ...
 */
package com.tianyang.common.persistence;
...
public abstract class DataEntity<T> extends BaseEntity<T> {
	...
	protected String createByName;	// 创建人--方便app-json转化
	protected String updateByName;	// 更新人--方便app-json转化
	protected String createByOfficeName;	// 创建人机构--方便app-json转化
	protected String updateByOfficeName;	// 更新人机构--方便app-json转化
	...
	public String getUpdateByOfficeName() {
		return updateByOfficeName;
	}

	public void setUpdateByOfficeName(String updateByOfficeName) {
		this.updateByOfficeName = updateByOfficeName;
	}
