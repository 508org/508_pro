 ...
 */
package com.tianyang.common.utils.excel;
...
public class ImportExcel {
	...
	public int getLastDataRowNum(){
		...
		return this.sheet.getLastRowNum()+1;//修改于2017-6-10   刘笑林
	}
			...
			for (Object[] os : annotationList){
				...
				if (val != null){
					...
					if (StringUtils.isNotBlank(ef.dictType())){
						...
						val = DictUtils.getDictValue(val.toString(), ef.dictType(), val.toString());
					...
					try {
						if (valType == String.class){
							...
							if (ef.fieldType() != Class.class){
								...
								val = ef.fieldType().getMethod("getValue", String.class).invoke(null, val.toString());//修改于2017-6-9  刘笑林
							}else{
