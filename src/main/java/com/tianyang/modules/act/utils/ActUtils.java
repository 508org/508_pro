 ...
 */
package com.tianyang.modules.act.utils;
...
import com.tianyang.common.annotation.FieldName;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_TEST_AUDIT = new String[]{"test001", "oa_test_audit"};
