...
import com.tianyang.common.utils.excel.ExportExcel;
			...
			for (User user : list){
				try{
					if ("true".equals(checkLoginName("", user.getLoginName()))){
						...
						failureMsg.append("<br/>工号 "+user.getLoginName()+" 已存在; ");
						failureNum++;
					}
				}catch(ConstraintViolationException ex){
					failureMsg.append("<br/>工号 "+user.getLoginName()+" 导入失败：");
					...
					failureMsg.append("<br/>工号 "+user.getLoginName()+" 导入失败："+ex.getMessage());
				}
			}
			if (failureNum>0){
