...
import com.tianyang.test.entity.TestData;
import com.tianyang.test.service.TestDataService;
...
public class TestDataController extends BaseController {
	...
	public String list(TestData testData, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "tianyang/test/testDataList";
	}
	...
	public String form(TestData testData, Model model) {
		...
		return "tianyang/test/testDataForm";
	}
