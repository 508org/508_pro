...
<head>
	...
	<script type="text/javascript">
		...
		function getGroup(id){
			form.action='${ctx}/pc/pcClusteringMarket/list?grid='+id+'&flag=hide';
			form.submit();
		}
		function getManager(id){
			form.action='${ctx}/pc/pcClusteringMarket/count?grid='+id;
			form.submit();
		}
	</script>
</head>
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${list}" var="pcClusteringMarket">
			<tr>
				<td><a href="#"  onclick="javaScript:getManager('${pcClusteringMarket.attributedGrid.id}');">
					${pcClusteringMarket.attributedGrid.name}
				</a></td>
				<td><a href="#"  onclick="javaScript:getGroup('${pcClusteringMarket.attributedGrid.id}');">
