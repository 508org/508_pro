...
<head>
	...
	<script type="text/javascript">
		...
		function getGroup(id){
			...
			form.action='${ctx}/pc/pcGroup/list?manager='+id+'&flag=hide';
			form.submit();
		}
...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed" >
		<thead>
		    <tr> 
		        <th style="vertical-align: middle !important;text-align: center;" rowspan="3">客户经理</th>
		...
		<c:forEach items="${list}" var="pcGroup">
			<tr>
				<td>
					${pcGroup.customerManagerNumber.name}
				</td>
				<td><a href="#"  onclick="javaScript:getGroup('${pcGroup.customerManagerNumber.id}');">
					${pcGroup.groupCount}
				</a></td>
				<td>
